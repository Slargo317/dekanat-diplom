...
const demo = {
  ...
  forms: [
    { form: "full_time", value: 8 },
    { form: "part_time", value: 3 },
    { form: "mixed", value: 2 },
    { form: "evening", value: 1 },
  ],
  attendance: {
    totals: [
  ...
  students: [
    ...
    { last_name: "Сидоров", first_name: "Никита", middle_name: "Олегович", group_name: "ЭК-22", record_book_number: "ЭК-22004", status: "academic_leave", form: "part_time", funding: "budget", specialty_name: "Экономика" },
  ...
  groups: [
    { id: "demo-is", name: "ИС-21", specialty_name: "Информационные системы", set_year: 2021, students_count: 6, active_count: 6 },
    { id: "demo-pi", name: "ПИ-20", specialty_name: "Прикладная информатика", set_year: 2020, students_count: 5, active_count: 5 },
    { id: "demo-ek", name: "ЭК-22", specialty_name: "Экономика", set_year: 2022, students_count: 4, active_count: 3 },
  ],
  statements: [
